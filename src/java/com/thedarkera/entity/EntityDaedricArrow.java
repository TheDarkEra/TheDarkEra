...
public class EntityDaedricArrow extends Entity implements IProjectile
{
	...
	public EntityDaedricArrow(World p_i1755_1_, EntityLivingBase p_i1755_2_, EntityLivingBase p_i1755_3_, float p_i1755_4_, float p_i1755_5_)
	{
		...
		posY = p_i1755_2_.posY + (double)p_i1755_2_.getEyeHeight() - 0.10000000149011612D;
		...
		if (d3 >= 1.0E-7D)
		{
			...
			double d4 = d0 / d3;
			double d5 = d2 / d3;
			setLocationAndAngles(p_i1755_2_.posX + d4, posY, p_i1755_2_.posZ + d5, f2, f3);
			yOffset = 0.0F;
	...
	public EntityDaedricArrow(World p_i1756_1_, EntityLivingBase p_i1756_2_, float p_i1756_3_)
	{
		...
		setSize(0.5F, 0.5F);
		setLocationAndAngles(p_i1756_2_.posX, p_i1756_2_.posY + (double)p_i1756_2_.getEyeHeight(), p_i1756_2_.posZ, p_i1756_2_.rotationYaw, p_i1756_2_.rotationPitch);
	 ...
	 public void setThrowableHeading(double p_70186_1_, double p_70186_3_, double p_70186_5_, float p_70186_7_, float p_70186_8_)
	{
	 ...
	 public void writeEntityToNBT(NBTTagCompound p_70014_1_)
	 {
		 ...
		 p_70014_1_.setByte("inTile", (byte)Block.getIdFromBlock(field_145790_g));
	 ...
	 public void onCollideWithPlayer(EntityPlayer p_70100_1_)
	 {
		 if (!worldObj.isRemote && inGround && arrowShake <= 0)
		 {
			 ...
			 if (canBePickedUp == 1 && !p_70100_1_.inventory.addItemStackToInventory(new ItemStack(Items.arrow, 1)))
			 {
				 flag = false;
			 }
