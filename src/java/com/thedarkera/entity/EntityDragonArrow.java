...
public class EntityDragonArrow extends Entity implements IProjectile {
	...
	public EntityDragonArrow(World world) {
		super(world);
	...
	public EntityDragonArrow(World p_i1754_1_, double p_i1754_2_,
	...
	public EntityDragonArrow(World p_i1755_1_, EntityLivingBase p_i1755_2_,
	...
	public EntityDragonArrow(World p_i1756_1_, EntityLivingBase p_i1756_2_,
			float p_i1756_3_) {
		super(p_i1756_1_);
		renderDistanceWeight = 10.0D;
