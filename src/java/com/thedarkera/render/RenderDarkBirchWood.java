...
public class RenderDarkBirchWood implements ISimpleBlockRenderingHandler {
	...
	public boolean renderWorldBlock(IBlockAccess world, int x, int y, int z,
		...
		if (modelID == renderId) {
			...
			if (world.getBlock(x, y + 1, z) == Blocks.leaves) {
				renderer.setRenderBounds(0.33f, 0.66f, 0.33f, 0.66f, 1.15f,
						0.66f);
				renderer.renderStandardBlock(block, x, y, z);
			}
			...
			if (world.getBlock(x + 1, y, z) == Blocks.leaves) {
				renderer.setRenderBounds(0.33f, 0.33f, 0.33f, 1.15f, 0.66f,
						0.66f);
				renderer.renderStandardBlock(block, x, y, z);
			}
			...
			if (world.getBlock(x - 1, y, z) == Blocks.leaves) {
				renderer.setRenderBounds(-0.15f, 0.33f, 0.33f, 0.33f, 0.66f,
						0.66f);
				renderer.renderStandardBlock(block, x, y, z);
			}
			...
			if (world.getBlock(x, y, z + 1) == Blocks.leaves) {
				renderer.setRenderBounds(0.33f, 0.33f, 0.33f, 0.66f, 0.66f,
						1.15f);
				renderer.renderStandardBlock(block, x, y, z);
			}
			...
			if (world.getBlock(x, y, z - 1) == Blocks.leaves) {
				renderer.setRenderBounds(0.33f, 0.33f, -0.15f, 0.66f, 0.66f,
						0.33f);
				renderer.renderStandardBlock(block, x, y, z);
			}
		}
