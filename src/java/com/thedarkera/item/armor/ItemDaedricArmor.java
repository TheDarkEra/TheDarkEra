...
public class ItemDaedricArmor extends ItemArmor
{
	...
	{
		if (player.getCurrentArmor(0) != null && player.getCurrentArmor(0).getItem().equals(TDEArmors.daedric_boots) 
				&& player.getCurrentArmor(1) != null && player.getCurrentArmor(1).getItem().equals(TDEArmors.daedric_leggings) 
				&& player.getCurrentArmor(2) != null && player.getCurrentArmor(2).getItem().equals(TDEArmors.daedric_chestplate) 
				&& player.getCurrentArmor(3) != null && player.getCurrentArmor(3).getItem().equals(TDEArmors.daedric_helmet))
		{
