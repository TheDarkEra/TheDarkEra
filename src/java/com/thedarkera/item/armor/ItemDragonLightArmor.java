...
{
	public ItemDragonLightArmor(ArmorMaterial material, int armorType, String name)
	{
	...
	{
		if (stack.getItem() == TDEArmors.dragon_light_helmet || stack.getItem() == TDEArmors.dragon_light_chestplate || stack.getItem() == TDEArmors.dragon_light_boots)
		{
