...
public class ItemWeeder extends Item { // Acts like ItemHoe but for weedy/dead
	...
	public boolean onItemUse(ItemStack p_77648_1_, EntityPlayer p_77648_2_,
		...
		if (!p_77648_2_.canPlayerEdit(p_77648_4_, p_77648_5_, p_77648_6_,
			...
			UseHoeEvent event = new UseHoeEvent(p_77648_2_, p_77648_1_,
			...
			Block block = p_77648_3_.getBlock(p_77648_4_, p_77648_5_,
					p_77648_6_);

			if (p_77648_7_ != 0
					&& p_77648_3_.getBlock(p_77648_4_, p_77648_5_ + 1,
							p_77648_6_).isAir(p_77648_3_, p_77648_4_,
							p_77648_5_ + 1, p_77648_6_)
					&& (block == Blocks.grass || block == TDEBlocks.dead_grass /**
					 * 
					 * || block == TDEBlocks.weedy_dirt
					 */
					)) {
