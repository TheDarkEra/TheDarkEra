	...
	public class TeleporterDark extends Teleporter
	{
	    ...
	    public boolean placeInExistingPortal(Entity par1Entity, double par2, double par4, double par6, float par8)
	    {
	        ...
	        else
	        {
	            for (k1 = l - short1; k1 <= l + short1; ++k1)
	            {
	                ...
	                for (int l1 = i1 - short1; l1 <= i1 + short1; ++l1)
	                {
	                    ...
	                    {
	                        if (this.worldServerInstance.getBlock(k1, i2, l1) == TDEBlocks.dark_portal)
	                        {
	                            while (this.worldServerInstance.getBlock(k1, i2 - 1, l1) == TDEBlocks.dark_portal)
	                            {
	                                --i2;
	                            }
	        ...
	        if (d3 >= 0.0D)
	        {
	            ...
	            if (this.worldServerInstance.getBlock(i - 1, j, k) == TDEBlocks.dark_portal)
	            {
	                j2 = 2;
	            }
	            ...
	            if (this.worldServerInstance.getBlock(i, j, k - 1) == TDEBlocks.dark_portal)
	            {
	                j2 = 3;
	            }
	        ...
	        for (k2 = 0; k2 < 4; ++k2)
	        {
	            for (i3 = 0; i3 < 4; ++i3)
	            {
	                for (l2 = -1; l2 < 4; ++l2)
	                {
	                    ...
	                    this.worldServerInstance.setBlock(k3, j3, i4, flag ? Blocks.sandstone : TDEBlocks.dark_portal, 0, 2);
	                }
	            }
