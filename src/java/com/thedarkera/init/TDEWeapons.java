...
public class TDEWeapons {
	...
	static ToolMaterial m_dark_stone_dagger = EnumHelper.addToolMaterial("dark_stone_dagger", 1, 200, 5.3F, 2F, 7);
	static ToolMaterial steel = EnumHelper.addToolMaterial("steel", 2, 325, 8.0F, 3F, 18);
	static ToolMaterial m_steel_dagger = EnumHelper.addToolMaterial("steel_dagger", 2, 325, 8.0F, 2.7F, 18);
	...
	public static void init()
	 {
		...
		//Daggers
		steel_dagger = new ItemModDagger(m_steel_dagger, "steel_dagger");
