...
//	{
//	return (WorldGenerator)(par1Random.nextInt(5) == 0 ? this.worldGeneratorForest : (par1Random.nextInt(10) == 0 ? this.WorldGenDeadTrees : this.worldGeneratorTrees));
...
//	public WorldGenAbstractTree func_150567_a(Random p_150567_1_)
 //   {
//        return (WorldGenAbstractTree)(p_150567_1_.nextInt(10) == 0 ? new WorldGenDeadTrees : (p_150567_1_.nextInt(2) == 0 ? new WorldGenShrub(3, 0) : (!this.field_150614_aC && p_150567_1_.nextInt(3) == 0 ? new WorldGenMegaJungle(false, 10, 20, 3, 3) : new WorldGenTrees(false, 4 + p_150567_1_.nextInt(7), 3, 3, true))));
//    }
