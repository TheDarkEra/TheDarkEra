     ...
     //   	BiomeDecoratorTDE.howMenyTrees = BiomeLightForest.treesPerChunk;
            ...
            for(int a = 0; a < i; ++a){
                if(i == BiomeDecoratorTDE.randomGenerator.nextInt(8)){
                    chunkX = BiomeDecoratorTDE.chunk_X + BiomeDecoratorTDE.randomGenerator.nextInt(16) + 8;
                    chunkZ = BiomeDecoratorTDE.chunk_Z + BiomeDecoratorTDE.randomGenerator.nextInt(16) + 8;
                    y = BiomeDecoratorTDE.currentWorld.getTopSolidOrLiquidBlock(chunkX, chunkZ);
                    block = BiomeDecoratorTDE.currentWorld.getBlock(chunkX, y, chunkZ);
                    blockA = BiomeDecoratorTDE.currentWorld.getBlock(chunkX, y - 1, chunkZ);
                    if(block != Blocks.air || block != Blocks.water){
                        if(blockA != Blocks.air || blockA != Blocks.water){
                    //    	BiomeDecoratorTDE.smallTree.generate(BiomeDecoratorTDE.currentWorld, BiomeDecoratorTDE.randomGenerator, chunkX, y, chunkZ);
                        }
                    }
                }
                /** Generates Big tree **/
                if(i == BiomeDecoratorTDE.randomGenerator.nextInt(15)){
                    ...
                    if(block != Blocks.air || block != Blocks.water){
                        if(blockA != Blocks.air || blockA != Blocks.water){
                       // 	BiomeDecoratorTDE.bigTree.generate(BiomeDecoratorTDE.currentWorld, BiomeDecoratorTDE.randomGenerator, chunkX, y, chunkZ);
                        }
                    }
                }
            }
  ...
  //  }
    ...
    private static void genStandardOre(int spawnWeight, WorldGenerator generatorToSpawn, int minSpawnHeight, int maxYSpawnHeight) {
        for (int l = 0; l < spawnWeight; ++l) {
            int i1 = BiomeDecoratorTDE.chunk_X + BiomeDecoratorTDE.randomGenerator.nextInt(16);
            int j1 = BiomeDecoratorTDE.randomGenerator.nextInt(maxYSpawnHeight - minSpawnHeight) + minSpawnHeight;
            int k1 = BiomeDecoratorTDE.chunk_Z + BiomeDecoratorTDE.randomGenerator.nextInt(16);
            generatorToSpawn.generate(BiomeDecoratorTDE.currentWorld, BiomeDecoratorTDE.randomGenerator, i1, j1, k1);
        }
    }
}
