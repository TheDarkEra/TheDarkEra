...
public abstract class TDEWorldGenHugeTree extends WorldGenAbstractTree
{
    ...
    public TDEWorldGenHugeTree(boolean doBlockNotify, int baseTreeHight, int p_i45458_3_, int metaWood, int metaLeaves)
    {
        super(doBlockNotify);
        this.baseHeight = baseTreeHight;
