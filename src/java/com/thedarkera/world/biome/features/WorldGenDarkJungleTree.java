...
public class WorldGenDarkJungleTree extends WorldGenHugeTrees
{
    private static final String __OBFID = "CL_00000420";

    public WorldGenDarkJungleTree(boolean p_i45456_1_, int p_i45456_2_, int p_i45456_3_, int p_i45456_4_, int p_i45456_5_)
    {
        ...
        else
        {
            ...
            for (int i1 = p_76484_4_ + l - 2 - p_76484_2_.nextInt(4); i1 > p_76484_4_ + l / 2; i1 -= 2 + p_76484_2_.nextInt(4))
            {
                ...
                for (l1 = 0; l1 < 5; ++l1)
                {
                    ...
                    this.setBlockAndNotifyAdequately(p_76484_1_, j1, i1 - 3 + l1 / 2, k1, TDEBlocks.blockLog3, this.woodMetadata);
                }
            ...
            for (int l2 = 0; l2 < l; ++l2)
            {
                ...
                {
                    this.setBlockAndNotifyAdequately(p_76484_1_, p_76484_3_, p_76484_4_ + l2, p_76484_5_, TDEBlocks.blockLog3, this.woodMetadata);
                ...
                if (l2 < l - 1)
                {
                    ...
                    {
                        this.setBlockAndNotifyAdequately(p_76484_1_, p_76484_3_ + 1, p_76484_4_ + l2, p_76484_5_, TDEBlocks.blockLog3, this.woodMetadata);
                    ...
                    {
                        this.setBlockAndNotifyAdequately(p_76484_1_, p_76484_3_ + 1, p_76484_4_ + l2, p_76484_5_ + 1, TDEBlocks.blockLog3, this.woodMetadata);
                    ...
                    {
                        this.setBlockAndNotifyAdequately(p_76484_1_, p_76484_3_, p_76484_4_ + l2, p_76484_5_ + 1, TDEBlocks.blockLog3, this.woodMetadata);
