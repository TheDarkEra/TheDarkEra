...
public class WorldGenDeadTree extends WorldGenAbstractTree {
	...
	public WorldGenDeadTree(Block wood, Block leaves, int metaWood,
			int metaLeaves) {
		this(wood, leaves, metaWood, metaLeaves, false, 4, 3, false);
	}

	public WorldGenDeadTree(Block wood, Block leaves, int metaWood,
			int metaLeaves, boolean doBlockNotify, int minTreeHight,
			int randomTreeHight, boolean vinesGrow) {
		super(doBlockNotify);
		this.wood = wood;
		this.leaves = leaves;
	...
	public boolean generate(World p_76484_1_, Random p_76484_2_,
		...
		if (p_76484_4_ >= 1 && p_76484_4_ + l + 1 <= 256) {
			...
			if (!flag) {
				...
				Block block2 = p_76484_1_.getBlock(p_76484_3_, p_76484_4_ - 1,
						p_76484_5_);

				boolean isSoil = block2.canSustainPlant(p_76484_1_, p_76484_3_,
						p_76484_4_ - 1, p_76484_5_, ForgeDirection.UP,
						(BlockSapling) TDEBlocks.saplings);
				if (isSoil && p_76484_4_ < 256 - l - 1) {
					block2.onPlantGrow(p_76484_1_, p_76484_3_, p_76484_4_ - 1,
							p_76484_5_, p_76484_3_, p_76484_4_, p_76484_5_);
					b0 = 3;
					byte b1 = 0;
					int l1;
					int i2;
					...
					for (k1 = p_76484_4_ - b0 + l; k1 <= p_76484_4_ + l; ++k1) {
						...
						for (i2 = p_76484_3_ - l1; i2 <= p_76484_3_ + l1; ++i2) {
							...
							for (int k2 = p_76484_5_ - l1; k2 <= p_76484_5_
									+ l1; ++k2) {
								int l2 = k2 - p_76484_5_;

								if (Math.abs(j2) != l1 || Math.abs(l2) != l1
										|| p_76484_2_.nextInt(2) != 0
										&& i3 != 0) {
									Block block1 = p_76484_1_.getBlock(i2, k1,
											k2);

									if (block1.isAir(p_76484_1_, i2, k1, k2)
											|| block1.isLeaves(p_76484_1_, i2,
													k1, k2)) {
										this.setBlockAndNotifyAdequately(
												p_76484_1_, i2, k1, k2,
												TDEBlocks.blockLeaves,
												this.metaLeaves);
									}
								}
							}
					...
					for (k1 = 0; k1 < l; ++k1) {
						block = p_76484_1_.getBlock(p_76484_3_,
								p_76484_4_ + k1, p_76484_5_);

						if (block.isAir(p_76484_1_, p_76484_3_,
								p_76484_4_ + k1, p_76484_5_)
								|| block.isLeaves(p_76484_1_, p_76484_3_,
										p_76484_4_ + k1, p_76484_5_)) {
							this.setBlockAndNotifyAdequately(p_76484_1_,
									p_76484_3_, p_76484_4_ + k1, p_76484_5_,
									TDEBlocks.log_dead, this.metaWood);

							if (this.vinesGrow && k1 > 0) {
								if (p_76484_2_.nextInt(3) > 0
										&& p_76484_1_.isAirBlock(
												p_76484_3_ - 1,
												p_76484_4_ + k1, p_76484_5_)) {
									this.setBlockAndNotifyAdequately(
											p_76484_1_, p_76484_3_ - 1,
											p_76484_4_ + k1, p_76484_5_,
											Blocks.vine, 8);
								}
								...
								if (p_76484_2_.nextInt(3) > 0
										&& p_76484_1_
												.isAirBlock(p_76484_3_,
														p_76484_4_ + k1,
														p_76484_5_ - 1)) {
									this.setBlockAndNotifyAdequately(
											p_76484_1_, p_76484_3_, p_76484_4_
													+ k1, p_76484_5_ - 1,
											Blocks.vine, 1);
								}
					...
					if (this.vinesGrow) {
						for (k1 = p_76484_4_ - 3 + l; k1 <= p_76484_4_ + l; ++k1) {
							...
							for (i2 = p_76484_3_ - l1; i2 <= p_76484_3_ + l1; ++i2) {
								for (j2 = p_76484_5_ - l1; j2 <= p_76484_5_
										+ l1; ++j2) {
									if (p_76484_1_.getBlock(i2, k1, j2)
											.isLeaves(p_76484_1_, i2, k1, j2)) {
										if (p_76484_2_.nextInt(4) == 0
												&& p_76484_1_.getBlock(i2 - 1,
														k1, j2).isAir(
														p_76484_1_, i2 - 1, k1,
														j2)) {
											this.growVines(p_76484_1_, i2 - 1,
													k1, j2, 8);
										}
										...
										if (p_76484_2_.nextInt(4) == 0
												&& p_76484_1_.getBlock(i2, k1,
														j2 - 1).isAir(
														p_76484_1_, i2, k1,
														j2 - 1)) {
											this.growVines(p_76484_1_, i2, k1,
													j2 - 1, 1);
										}
