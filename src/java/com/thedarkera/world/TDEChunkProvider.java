...
public class TDEChunkProvider implements IChunkProvider {
	...
	public void replaceBlocksForBiome(int p_147422_1_, int p_147422_2_,
		...
		ChunkProviderEvent.ReplaceBiomeBlocks event = new ChunkProviderEvent.ReplaceBiomeBlocks(
				this, p_147422_1_, p_147422_2_, p_147422_3_, p_147422_4_,
				p_147422_5_);
		...
		double d0 = 0.03125D;
		this.stoneNoise = this.noiseGen4.func_151599_a(this.stoneNoise,
				(double) (p_147422_1_ * 16), (double) (p_147422_2_ * 16), 16,
		...
		for (int k = 0; k < 16; ++k) {
			for (int l = 0; l < 16; ++l) {
				...
				biomegenbase.genTerrainBlocks(this.worldObj, this.rand,
						p_147422_3_, p_147422_4_, p_147422_1_ * 16 + k,
	...
	/**
	 * Will return back a chunk, if it doesn't exist and it's not an MP client,
	...
	public Chunk provideChunk(int par1, int par2) {
		...
		this.biomesForGeneration = this.worldObj.getWorldChunkManager()
				.loadBlockGeneratorData(this.biomesForGeneration, par1 * 16,
						par2 * 16, 16, 16);
		this.replaceBlocksForBiome(par1, par2, ablock, abyte,
		...
		if (this.mapFeaturesEnabled) {
			this.mineshaftGenerator.func_151539_a(this, this.worldObj, par1,
					par2, ablock);
			this.villageGenerator.func_151539_a(this, this.worldObj, par1,
					par2, ablock);
			this.strongholdGenerator.func_151539_a(this, this.worldObj, par1,
					par2, ablock);
	...
	private void func_147423_a(int p_147423_1_, int p_147423_2_, int p_147423_3_) {
		...
		double d2 = 512.0D;
		double d3 = 512.0D;
		this.d4 = this.noiseGen6.generateNoiseOctaves(this.d4, p_147423_1_,
				p_147423_3_, 5, 5, 200.0D, 200.0D, 0.5D);
		this.d1 = this.noiseGen3.generateNoiseOctaves(this.d1, p_147423_1_,
				p_147423_2_, p_147423_3_, 5, 33, 5, 8.555150000000001D,
				4.277575000000001D, 8.555150000000001D);
		this.d2 = this.noiseGen1.generateNoiseOctaves(this.d2, p_147423_1_,
				p_147423_2_, p_147423_3_, 5, 33, 5, 684.412D, 684.412D,
				684.412D);
		this.d3 = this.noiseGen2.generateNoiseOctaves(this.d3, p_147423_1_,
				p_147423_2_, p_147423_3_, 5, 33, 5, 684.412D, 684.412D,
				684.412D);
		boolean flag1 = false;
		boolean flag = false;
	...
	public void populate(IChunkProvider par1IChunkProvider, int par2, int par3) {
		...
		if (TerrainGen.populate(par1IChunkProvider, worldObj, rand, par2, par3,
			...
			if (l1 < 63 || this.rand.nextInt(10) == 0) {
				(new WorldGenLakes(Blocks.lava)).generate(this.worldObj,
						this.rand, k1, l1, i2);
			}
		}
	...
	public List getPossibleCreatures(EnumCreatureType par1EnumCreatureType,
		...
		return par1EnumCreatureType == EnumCreatureType.monster
				&& this.scatteredFeatureGenerator.func_143030_a(par2, par3,
	...
	public ChunkPosition func_147416_a(World p_147416_1_, String p_147416_2_,
		...
		return "Stronghold".equals(p_147416_2_)
