...
//public class WorldGenMinableTDE extends WorldGenerator
//{
...
//
//public WorldGenMinableTDE(int par1, int par2)
//{
...
//this(par1, par2, TDEBlocks.dark_stone.bLockID);
//}
//
//public WorldGenMinableTDE(int par1, int par2, int par3)
//{
...
//}
//
//public WorldGenMinableTDE(int id, int meta, int number, int target)
//{
...
//
//for (int l = 0; l <= this.numberofblocks;="">
//{
