...
import com.thedarkera.world.gen.layer.GenLayerTDE;
...
public class WorldChunkManagerTDE extends WorldChunkManager {
	...
	public WorldChunkManagerTDE(long seed, WorldType worldType)
	{
		this();
		// i changed this to my GenLayerTutorial
		GenLayer[] agenlayer = GenLayerTDE.makeTheWorld(seed, worldType);
		agenlayer = getModdedBiomeGenerators(worldType, seed, agenlayer);
		this.genBiomes = agenlayer[0];
		this.biomeIndexLayer = agenlayer[1];
	}

	public WorldChunkManagerTDE(World world)
	{
