...
public class BlockClayStairsItem extends ItemBlock {
	public BlockClayStairsItem(Block block) {
		super(block);
		setHasSubtypes(true);
	}
	...
	public String getUnlocalizedName(ItemStack itemstack) {
		...
		switch (itemstack.getItemDamage()) {
			...
			case 3:
				...
				break;
			default:
				System.out.println("Invalid metadata for Block dark_clay_stairs");
				name = "broken";
				break;
		}
