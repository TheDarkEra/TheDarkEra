...
public class BlockWool extends Block 
{
	...
	public BlockWool(Material material, Float hardness, Float resistance, String name, String tool, int lvl, Block.SoundType sound){
		super(material);
		String block = name;
	...
	public void registerBlockIcons(IIconRegister par1IconRegister)
	{
		...
		{
			icons[i] = par1IconRegister.registerIcon(TheDarkEra.MODID + ":" + "dark_wool" + i);
		}
	}
